...
public class XmlParserBStopArr {

    static public ArrayList<BStopArrBus> getBStopArrXml(String response, ArrayList<BStopArrBus> bsArrList){
        String arsNo = null;
        String bstopId = null;
        String nodeNm = null;
        String gpsX = null;
            ...
            while (eventType != XmlPullParser.END_DOCUMENT){
                if(eventType == XmlPullParser.START_DOCUMENT){
                    ...
                    if (eventType == XmlPullParser.TEXT){
                        if(is_arsNo){
                            arsNo = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).arsNo = arsNo;
                        ...
                        if(is_bstopId){
                            bstopId = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).bstopId = bstopId;
                        ...
                        if(is_nodeNm){
                            nodeNm = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).nodeNm = nodeNm;
                        ...
                        if(is_gpsX){
                            gpsX = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).gpsX = gpsX;
                        ...
                        if(is_gpsY){
                            gpsY = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).gpsY = gpsY;
                        ...
                        if(is_bustype){
                            bustype = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).bustype = bustype;
                        ...
                        if(is_lineNo){
                            lineNo = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).lineNo = lineNo;
                        ...
                        if(is_lineid){
                            lineid = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).lineid = lineid;
                        ...
                        if(is_bstopidx){
                            ...
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).bstopidx = bstopidx;
                        ...
                        if(is_carNo1){
                            carNo1 = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).carNo1 = carNo1;
                        ...
                        if(is_min1){
                            min1 = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).min1 = min1;
                        ...
                        if(is_station1){
                            ...
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).station1 = station1;
                        ...
                        if(is_lowplate1){
                            ...
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).lowplate1 = lowplate1;
                        ...
                        if(is_carNo2){
                            carNo2 = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).carNo2 = carNo2;
                        ...
                        if(is_min2){
                            min2 = xpp.getText();
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).min2 = min2;
                        ...
                        if(is_station2){
                            ...
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).station2 = station2;
                        ...
                        if(is_lowplate2){
                            ...
                            bsArrList.add(new BStopArrBus());
                            bsArrList.get(bsArrList.size() - 1).lowplate2 = lowplate2;
